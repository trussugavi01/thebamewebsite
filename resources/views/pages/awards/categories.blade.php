...
@section('meta_title', 'Award Categories | B.A.M.E Health & Care Awards 2025')
@section('meta_description', 'Explore all award categories for The National B.A.M.E Health & Care Awards 2025. From healthcare leadership to community impact, discover categories celebrating excellence in UK health and social care.')
@section('meta_keywords', 'BAME awards categories, healthcare award categories, NHS awards, diversity categories, leadership awards, healthcare excellence categories')
@section('canonical_url', route('awards.categories'))

@section('og_title', 'Award Categories | B.A.M.E Health & Care Awards')
@section('og_description', 'Celebrating Excellence in Health & Social Care across multiple award categories.')
@section('og_url', route('awards.categories'))

@section('twitter_title', 'B.A.M.E Awards Categories')
@section('twitter_description', 'Discover all award categories celebrating healthcare excellence.')

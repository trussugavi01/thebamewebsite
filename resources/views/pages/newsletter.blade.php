...
@section('meta_title', 'Newsletter | B.A.M.E Health & Care Awards - Stay Connected')
@section('meta_description', 'Subscribe to The National B.A.M.E Health & Care Awards newsletter for exclusive updates, event announcements, inspiring stories, and insights about healthcare equity and diversity.')
@section('meta_keywords', 'BAME awards newsletter, healthcare updates, diversity newsletter, awards announcements, health equity news, subscribe newsletter')
@section('canonical_url', route('newsletter'))

@section('og_title', 'Newsletter Signup | B.A.M.E Health & Care Awards')
@section('og_description', 'Stay connected with exclusive updates, event announcements, and inspiring stories from the healthcare equity community.')
@section('og_url', route('newsletter'))

@section('twitter_title', 'B.A.M.E Awards Newsletter')
@section('twitter_description', 'Subscribe for updates and inspiring healthcare stories.')

@section('title', 'Stay Connected - Newsletter Signup')
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="order-1 lg:order-2">
                    ...
                    <form action="{{ route('newsletter.subscribe') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-gray-700 mb-3 uppercase tracking-wide">CUSTOMISE YOUR UPDATES:</p>
                            <div class="space-y-3">

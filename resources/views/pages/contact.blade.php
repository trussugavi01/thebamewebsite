...
@section('meta_title', 'Contact Us | B.A.M.E Health & Care Awards - Get in Touch')
@section('meta_description', 'Contact The National B.A.M.E Health & Care Awards team for inquiries about nominations, sponsorship, media requests, or general information. Email: info@bamehscawards.org')
@section('meta_keywords', 'contact BAME awards, healthcare awards inquiry, sponsorship opportunities, media contact, awards information, nomination help')
@section('canonical_url', route('contact'))

@section('og_title', 'Contact B.A.M.E Health & Care Awards')
@section('og_description', 'Get in touch with our team for questions about the awards, summit, or partnership opportunities.')
@section('og_url', route('contact'))

@section('twitter_title', 'Contact B.A.M.E Health & Care Awards')
@section('twitter_description', 'Reach out to our team for inquiries and support.')
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="subject" name="subject" required
                                ...
                                <option value="Awards Process" {{ old('subject') === 'Awards Process' ? 'selected' : '' }}>Awards Process</option>
                                <option value="Summit Information" {{ old('subject') === 'Summit Information' ? 'selected' : '' }}>Summit Information</option>
            ...
            <div class="mt-12 text-center">
                ...
                <a href="{{ route('faq') }}" class="inline-flex items-center text-teal-400 hover:text-teal-300 font-semibold">

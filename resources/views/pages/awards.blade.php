...
@section('meta_title', 'The Awards | B.A.M.E Health & Care Awards 2025 - Categories & Nominations')
@section('meta_description', 'Discover the B.A.M.E Health & Care Awards categories celebrating outstanding contributions from Black, Asian and Minority Ethnic professionals in UK health and social care. Nominate today!')
@section('meta_keywords', 'BAME awards categories, healthcare awards 2025, NHS nominations, diversity recognition, health care excellence, ethnic minority awards, healthcare leadership awards')
@section('canonical_url', route('awards'))

@section('og_title', 'The Awards | Celebrating Excellence in Health & Social Care')
@section('og_description', 'Recognising outstanding contributions from BAME staff and allies making significant improvements in UK health and care.')
@section('og_url', route('awards'))

@section('twitter_title', 'B.A.M.E Health & Care Awards Categories')
@section('twitter_description', 'Celebrating excellence and driving meaningful change in healthcare.')

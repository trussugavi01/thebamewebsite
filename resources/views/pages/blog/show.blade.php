...
<article class="py-12 bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            <div class="mb-8">
                <a href="{{ route('blog.index') }}" class="inline-flex items-center text-purple-600 hover:text-purple-700 font-semibold mb-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('blog.show', $post->slug) }}" class="text-purple-600 hover:text-purple-700 font-semibold inline-flex items-center text-sm">
                            Read More
...
<section class="py-16 bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 text-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto">
            <a href="{{ route('blog.index') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white text-purple-900 font-semibold rounded-lg hover:bg-gray-100 transition shadow-lg">
                View All Posts
            </a>
            <a href="{{ route('newsletter') }}" class="inline-flex items-center justify-center px-8 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-purple-900 transition">
                Subscribe
            </a>
        </div>
    </div>

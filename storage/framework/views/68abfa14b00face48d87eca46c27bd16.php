    ...
    <div class="w-full lg:w-2/5 flex items-center justify-center bg-white px-8 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-10">
                <a href="<?php echo e(route('home')); ?>" class="inline-block mb-8 transform hover:scale-105 transition duration-300">
                    <img src="<?php echo e(asset('images/bame-logo.png')); ?>" alt="B.A.M.E Logo" class="h-20 mx-auto">
                </a>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="email" 
                               ...
                               required 
                               autofocus
                               class="block w-full pl-12 pr-4 py-4 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-transparent transition duration-200 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"
            ...
            <div class="mt-8 text-center">
                <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center text-sm text-gray-600 hover:text-purple-600 font-medium transition group">
            ...
            <div class="mt-12 text-center">
                <p class="text-gray-400 text-xs">
                    © <?php echo e(date('Y')); ?> B.A.M.E Health & Care Awards. All rights reserved.
                </p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\thebamewebsite\resources\views/auth/login.blade.php ENDPATH**/ ?>
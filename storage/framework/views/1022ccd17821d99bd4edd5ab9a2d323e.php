...
<?php $__env->startSection('title', 'Celebrating Excellence, Driving Equity'); ?>
        ...
        <div class="w-full max-w-7xl mx-auto">
            ...
            <div class="text-center max-w-[60ch] mx-auto px-4 sm:px-6">
                ...
                <div class="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center px-2 sm:px-0 pb-6 sm:pb-8" style="padding-top: 100px;">
                    ...
                    <a 
                        href="<?php echo e(route('nominations')); ?>" 
        ...
        <div class="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-7xl mx-auto">
            <div class="card-animate group relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div class="relative h-80 overflow-hidden">
                    <img src="<?php echo e(asset('images/awards-ceremony-2025.jpg')); ?>" alt="National B.A.M.E Health & Care Awards 2025 Ceremony" class="w-full h-full object-cover object-center group-hover:scale-110 transition-transform duration-700">
                ...
                <div class="p-8 lg:p-10">
                    ...
                    <a href="<?php echo e(route('awards')); ?>" class="group/link inline-flex items-center text-purple-600 hover:text-purple-700 font-semibold transition-colors text-lg">
                        Learn More
            ...
            <div class="card-animate group relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div class="relative h-80 overflow-hidden">
                    <img src="<?php echo e(asset('images/bide-summit-2025.jpg')); ?>" alt="B.I.D.E Summit 2025 - Panel Discussion" class="w-full h-full object-cover object-center group-hover:scale-110 transition-transform duration-700">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent"></div>
                    <div class="absolute top-6 left-6">
                ...
                <div class="p-8 lg:p-10">
                    ...
                    <a href="<?php echo e(route('summit')); ?>" class="group/link inline-flex items-center text-purple-600 hover:text-purple-700 font-semibold transition-colors text-lg">
                        Explore the Summit
                        <svg class="w-5 h-5 ml-2 group-hover/link:translate-x-2 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                        </svg>
                ...
                <div class="lg:col-span-5 flex justify-center lg:justify-end">
                    <div class="w-full max-w-md">
                        <div class="bg-white/10 backdrop-blur-lg rounded-3xl p-8 md:p-10 border border-white/20 shadow-2xl">
                            ...
                            <a href="<?php echo e(route('contact')); ?>" class="group w-full flex items-center justify-center px-8 py-5 bg-white text-purple-600 hover:bg-teal-500 hover:text-white font-bold rounded-xl transition-all duration-300 shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 text-lg mb-6">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-3xl shadow-2xl p-10 md:p-14 border border-gray-100 relative overflow-hidden group hover:shadow-3xl transition-all duration-500">
                ...
                <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" class="flex flex-col sm:flex-row gap-4 relative z-10 mb-10 px-4 sm:px-0">
                    <?php echo csrf_field(); ?>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mt-12">
            <a href="<?php echo e(route('blog.index')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg transition shadow-lg">
                View All Blog Posts
...
<section class="py-20 bg-gradient-to-br from-purple-900 via-gray-900 to-purple-900 text-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="<?php echo e(route('summit')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-transparent border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-purple-900 transition">
                Get Your Passes
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\thebamewebsite\resources\views/pages/home.blade.php ENDPATH**/ ?>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="mb-8">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <a href="<?php echo e(route('admin.blog.index')); ?>" class="text-blue-600 hover:text-blue-700 font-medium inline-flex items-center transition">
                        <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\thebamewebsite\resources\views/admin/blog/create.blade.php ENDPATH**/ ?>
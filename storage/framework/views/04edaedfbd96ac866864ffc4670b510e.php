...
<?php $__env->startSection('meta_title', 'Award Categories | B.A.M.E Health & Care Awards 2025'); ?>
<?php $__env->startSection('meta_description', 'Explore all award categories for The National B.A.M.E Health & Care Awards 2025. From healthcare leadership to community impact, discover categories celebrating excellence in UK health and social care.'); ?>
<?php $__env->startSection('meta_keywords', 'BAME awards categories, healthcare award categories, NHS awards, diversity categories, leadership awards, healthcare excellence categories'); ?>
<?php $__env->startSection('canonical_url', route('awards.categories')); ?>

<?php $__env->startSection('og_title', 'Award Categories | B.A.M.E Health & Care Awards'); ?>
<?php $__env->startSection('og_description', 'Celebrating Excellence in Health & Social Care across multiple award categories.'); ?>
<?php $__env->startSection('og_url', route('awards.categories')); ?>

<?php $__env->startSection('twitter_title', 'B.A.M.E Awards Categories'); ?>
<?php $__env->startSection('twitter_description', 'Discover all award categories celebrating healthcare excellence.'); ?>

<?php $__env->startSection('title', 'Award Categories'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\thebamewebsite\resources\views/pages/awards/categories.blade.php ENDPATH**/ ?>
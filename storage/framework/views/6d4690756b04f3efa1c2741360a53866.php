        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <span class="text-purple-100">Welcome, <?php echo e(auth()->user()->name); ?></span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-purple-600">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-2xl font-bold text-gray-900"><?php echo e($stats['nominations']['total']); ?></span>
                    </div>
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500">Pending</span>
                        <span class="font-semibold text-gray-700"><?php echo e($stats['nominations']['pending']); ?></span>
                    </div>
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500">Shortlisted</span>
                        <span class="font-semibold text-purple-600"><?php echo e($stats['nominations']['shortlisted']); ?></span>
                    </div>
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500">Winners</span>
                        <span class="font-semibold text-green-600"><?php echo e($stats['nominations']['winners']); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-blue-600">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600">Total</span>
                        <span class="text-2xl font-bold text-gray-900"><?php echo e($stats['blog']['total']); ?></span>
                    </div>
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500">Published</span>
                        <span class="font-semibold text-green-600"><?php echo e($stats['blog']['published']); ?></span>
                    </div>
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500">Drafts</span>
                        <span class="font-semibold text-gray-700"><?php echo e($stats['blog']['draft']); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-teal-600">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-2xl font-bold text-gray-900"><?php echo e($stats['gallery']['total_images']); ?></span>
                    </div>
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500">Categories</span>
                        <span class="font-semibold text-gray-700"><?php echo e($stats['gallery']['categories']); ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-8">
                ...
                <div x-show="activeTab === 'nominations'" x-transition>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <a href="<?php echo e(route('admin.nominations.index')); ?>" 
                        ...
                        <a href="<?php echo e(route('admin.nominations.export')); ?>" 
                ...
                <div x-show="activeTab === 'gallery'" x-transition>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <a href="<?php echo e(route('admin.gallery.categories.index')); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\thebamewebsite\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>